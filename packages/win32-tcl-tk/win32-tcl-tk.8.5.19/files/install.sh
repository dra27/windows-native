...
case "$2" in
  ...
  cl)
    ...
    cd ../../win
    MSDEVDIR=trick nmake -nologo -f makefile.vc install-binaries install-libraries OUT_DIR=. INSTALLDIR=$4\\trick TCLDIR=$3\\tcl$1 LIB_INSTALL_DIR=$5 INCLUDE_INSTALL_DIR=$5 SCRIPT_INSTALL_DIR=$5\\tk$SERIES
    ;;
esac
